...
class UpcomingGames {
    ...
    var upcomingGameArray: [GameData] = []
    ...
    func getGames(completed: @escaping () -> () ) {
        ...
        consoles.loadData {
            ...
            let gamesURL = "https://www.giantbomb.com/api/games/?api_key=dfa758a5ce0f541751925d6104fe30cde783c507&field_list=name,guid,original_release_date&format=json&sort=original_release_date:desc&filter=original_release_date:\(todayDate)%7C\(futureDateString),platforms:\(itemToAppend)"
            ...
            Alamofire.request(gamesURL).responseJSON { response in
                ...
                case .success(let value):
                    ...
                    for index in 0..<numberOfGames {
                        ...
                        self.upcomingGameArray.append(gameDataItem)
